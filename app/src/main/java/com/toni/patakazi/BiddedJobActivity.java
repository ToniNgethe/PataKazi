...
import com.toni.patakazi.Adapters.BidderJobAdapter;
        ...
        m.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot mData : dataSnapshot.getChildren()) {
                    ...
                    Global.writeToLog("keyss", mData.getKey());
                    ...
                    databaseReference.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            users.add(u);
                            Global.writeToLog(u.getUser(), dataSnapshot.getKey());
...
//                if (users.size() <= 0) {
//                    bidRecycleView.setVisibility(View.GONE);
//                    layoutEmpty.setVisibility(View.VISIBLE);
//                    tvEmpty.setText("No bidders yet on this job");
//                }
