...
import com.toni.patakazi.Dialogs.CustomProgressDialog;
...
public class PostAskillActivity extends AppCompatActivity {
    ...
    private void submitSkill() {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // display errors in individual fields...
                if (TextUtils.isEmpty(title.getText())){
                    title.setError("Enter skill title");
                    return;
                }

                if (TextUtils.isEmpty(desc.getText())){
                    desc.setError("Enter skill description");
                    return;
                }

                if (TextUtils.isEmpty(charges.getText().toString())){
                    charges.setError("Enter your charging rate per hour");
                    return;
                }
    ...
    private void setUpViews() {
        ...
        submit = (CardView) findViewById(R.id.submitSkill);
